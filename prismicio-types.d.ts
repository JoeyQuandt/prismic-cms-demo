...
interface FooterDocumentData {
  ...
  /**
   * NavbarItems field in *Footer*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: footer.navbaritems
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  navbaritems: prismic.ContentRelationshipField<"navbar">;
}
...
export type AllDocumentTypes = FooterDocument | NavbarDocument | PageDocument;
